...
`image #image src=wc:Monument_Valley,_Utah,_USA_(23611451292).jpg "Monument Valley" cover right static box-shadow`
...
`map #map location=Q192017,4 "Monument Valley" marker right box-shadow`
`- location=Q118841`
`- location=Q777183`
`- location=Q223969`
